 ...
 * Use the [ContaktFragment.newInstance] factory method to
...
class ContaktFragment : Fragment() {
    ...
    lateinit var binding:FragmentContaktBinding
    ...
    companion object {
         ...
         * @return A new instance of fragment ContaktFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ContaktFragment().apply {
